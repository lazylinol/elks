...
#define MSDOS_DPB \
	(BLOCK_SIZE / sizeof(struct msdos_dir_entry)) /* dir entries/block */
...
#define MSDOS_DPS_SB(sb) \
	(512 / sizeof(struct msdos_dir_entry)) /* dirents/sector */
...
#define DEVINO_BASE \
	(MSDOS_DPB * 2) /* (DEVDIR_SIZE+MSDOS_DBP-1) & ~(MSDOS_DBP-1) */
