...
#define FATPROC \
	__far __attribute__((far_section, noinline, section(".fartext.fatfs")))
#else
#define FATPROC
#endif
...
#define MSDOS_FAT12_MAX_CLUSTERS \
	4084 /* maximum number of clusters in a 12 bit FAT */
...
cluster_t FATPROC fat_access(struct super_block *sb, cluster_t this,
			     cluster_t new_value);
...
extern int msdos_rename(struct inode *old_dir, const char *old_name,
...
int FATPROC msdos_get_entry_long(struct inode *dir, off_t *pos,
				 struct buffer_head **bh, char *name,
				 int *namelen, off_t *dirpos, ino_t *ino);
