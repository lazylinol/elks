...
#define cgatext_offset(col, row) \
	(cgatext_offset_col(col) + cgatext_offset_row(row))

/* Video cell displaing */
#define cgatext_put_cell(off, cell) pokew(off, cgatext_mem_SEG, cell)
#define cgatext_put_cell_xy(col, row, cell) \
	cgatext_put_cell(cgatext_offset(col, row), cell)
...
#define cgatext_cell_color(color_fg, color_bg) \
	(cgatext_attr_fg(color_fg) | cgatext_attr_bg(color_bg))
#define cgatext_cell_attr_c(attr, c) ((attr) | cgatext_cell_c(c))
#define cgatext_cell(color_fg, color_bg, c) \
	cgatext_cell_attr_c(cgatext_cell_color(color_fg, color_bg), c)
...
#define cgatext_clear() \
	cgatext_fill(   \
		cgatext_cell(cgatext_color_WHITE, cgatext_color_BLACK, ' '))
