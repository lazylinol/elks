...
static unsigned char xtkb_scan_shifted[] = {
	0,    033,  '!',  '\"', 0xFA, '$',  '%',  '&',	'/',  '(',  ')',
	'=',  '?',  168,  '\b', '\t', 'Q',  'W',  'E',	'R',  'T',  'Y',
	'U',  'I',  'O',  'P',	'^',  '*',  015,  0202, 'A',  'S',  'D',
	'F',  'G',  'H',  'J',	'K',  'L',  165,  0xF9, 166,  0200, 128,
...
static unsigned char xtkb_scan_ctrl_alt[] = {
	...
	'0',  '<',  '>',  '\b', '\t', 'q',  'w',  'e',	'r',  't',  'y',
	'u',  'i',  'o',  'p',	'[',  ']',  015,  0202, 'a',  's',  'd',
	'f',  'g',  'h',  'j',	'k',  'l',  164,  '{',	'\\', 0200, '}',
	'z',  'x',  'c',  'v',	'b',  'n',  'm',  ',',	'.',  '-',  0201,
	'*',  0203, ' ',  0204, 0241, 0242, 0243, 0244, 0245, 0246, 0247,
	0250, 0251, 0252, 0205, 0210, 0267, 0270, 0271, 0211, 0264, 0265,
	0266, 0214, 0261, 0262, 0263, 0272, 0177, 0,	0,    0
};

static unsigned char xtkb_scan_caps[] = {
	0,    033,  '1',  '2',	'3',  '4',  '5',  '6',	'7',  '8',  '9',
	'0',  '\'', 173,  '\b', '\t', 'Q',  'W',  'E',	'R',  'T',  'Y',
	'U',  'I',  'I',  'P',	'`',  '+',  015,  0202, 'A',  'S',  'D',
	'F',  'G',  'H',  'J',	'K',  'L',  165,  '<',	248,  0200, 128,
	'Z',  'X',  'C',  'V',	'B',  'N',  'M',  ',',	'.',  '-',  0201,
	'*',  0203, ' ',  0204, 0241, 0242, 0243, 0244, 0245, 0246, 0247,
	0250, 0251, 0252, 0205, 0210, 0267, 0270, 0271, 0211, 0264, 0265,
	0266, 0214, 0261, 0262, 0263, 0272, 0177, 0,	0,    '<'
