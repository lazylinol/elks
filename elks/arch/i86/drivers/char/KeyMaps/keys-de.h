...
static unsigned char xtkb_scan_shifted[89] = {
	0,    033,  '!',  '\"', '§',  '$',  '%',  '&',	'/',  '(',  ')',  '=',
	'?',  0140, '\b', '\t', 'Q',  'W',  'E',  'R',	'T',  'Z',  'U',  'I',
	'O',  'P',  'Ü',  '*',	015,  0202, 'A',  'S',	'D',  'F',  'G',  'H',
	'J',  'K',  'L',  'Ö',	'Ä',  '°',  0200, '\'', 'Y',  'X',  'C',  'V',
...
static unsigned char xtkb_scan_ctrl_alt[89] = {
	...
	'\\', '\'', '\b', '\t', '@',  'w',  'e',  'r',	't',  'z',  'u',  'i',
	'o',  'p',  'ü',  '~',	015,  0202, 0xa0, 's',	'd',  'f',  'g',  'h',
	'j',  'k',  'l',  'ö',	'ä',  '^',  0200, '#',	'y',  'x',  'c',  'v',
	'b',  'n',  0xB5, ',',	'.',  '-',  0201, '*',	0203, ' ',  0204, 0241,
