...
static unsigned char xtkb_scan[] = {
	0,    033,  '&',  0x82, '\"', '\'', '(',  '-',	0x8a, '_',  0x87, 0x85,
	')',  '=',  '\b', '\t', 'a',  'z',  'e',  'r',	't',  'y',  'u',  'i',
	'o',  'p',  '^',  '$',	015,  0202, 'q',  's',	'd',  'f',  'g',  'h',
	'j',  'k',  'l',  'm',	0x97, '*',  '?',  0134, 'w',  'x',  'c',  'v',
...
static unsigned char xtkb_scan_shifted[] = {
	...
	'O',  'P',  '"',  0x9c, 015,  0202, 'Q',  'S',	'D',  'F',  'G',  'H',
	'J',  'K',  'L',  'M',	'%',  0xe6, 0200, 0x9c, 'W',  'X',  'C',  'V',
	'B',  'N',  '?',  '.',	'/',  0x15, 0201, '*',	0203, ' ',  0204, 0221,
...
static unsigned char xtkb_scan_caps[] = {
	0,    033,  '1',  '2',	'3',  '4',  '5',  '6',	'7',  '8',  '9',  '0',
	0xf8, '_',  '\b', '\t', 'A',  'Z',  'E',  'R',	'T',  'Y',  'U',  'I',
	'O',  'P',  '?',  '*',	015,  0202, 'Q',  'S',	'D',  'F',  'G',  'H',
	'J',  'K',  'L',  'M',	'%',  '?',  0200, 0x9c, 'W',  'X',  'C',  'V',
